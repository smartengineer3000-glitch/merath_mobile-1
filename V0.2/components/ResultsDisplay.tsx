  ...
  useEffect(() => {
    ...
    const listener = animation.addListener(({ value: progress }) => {
      const newValue =
        ...
        (value - previousValueRef.current) * progress;
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            ...
            {currentResult.shares &&
              currentResult.shares.map((share: any, index: number) => {
            ...
            <View style={styles.summaryRow}>
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      currentResult.confidence > 90 ? "#4caf50" : "#ff9800",
                  },
                ]}
              >
                <AnimatedNumber
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.shareOptions}>
              ...
              >
                <View
                  style={[styles.shareIcon, { backgroundColor: "#d32f2f" }]}
                >
              ...
              >
                <View
                  style={[styles.shareIcon, { backgroundColor: "#2196f3" }]}
                >
              ...
              >
                <View
                  style={[styles.shareIcon, { backgroundColor: "#4caf50" }]}
                >
              ...
              >
                <View
                  style={[styles.shareIcon, { backgroundColor: "#ff9800" }]}
                >
