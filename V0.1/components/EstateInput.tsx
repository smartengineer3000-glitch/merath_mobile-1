        ...
        >
          ...
          <View style={styles.inputGroup}>
            ...
            {getFieldError('estate.total') && (
              <Text style={styles.fieldError}>{getFieldError('estate.total')?.userMessage}</Text>
            )}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            {getFieldError('estate.funeral') && (
              <Text style={styles.fieldError}>{getFieldError('estate.funeral')?.userMessage}</Text>
            )}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            {getFieldError('estate.debts') && (
              <Text style={styles.fieldError}>{getFieldError('estate.debts')?.userMessage}</Text>
            )}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            {getFieldError('estate.will') && (
              <Text style={styles.fieldError}>{getFieldError('estate.will')?.userMessage}</Text>
            )}
          </View>
          ...
          {validationResult && (
            <>
              {validationResult.errors.filter(e => !e.field.startsWith('estate.')).length > 0 && (
                <View style={styles.validationContainer}>
                  {validationResult.errors.filter(e => !e.field.startsWith('estate.')).map((error, index) => (
          ...
          <View style={styles.summary}>
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>{formatCurrency(currentEstate.total)}</Text>
            </View>
            
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>- تكاليف التجهيز:</Text>
              <Text style={styles.summaryValue}>{formatCurrency(currentEstate.funeral)}</Text>
            </View>
            
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>- الديون:</Text>
              <Text style={styles.summaryValue}>{formatCurrency(currentEstate.debts)}</Text>
            </View>
            
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>- الوصية:</Text>
              <Text style={styles.summaryValue}>{formatCurrency(currentEstate.will)}</Text>
            </View>
            ...
            <View style={[styles.summaryRow, styles.netEstateRow]}>
              ...
              <Text style={styles.netEstateValue}>
                {formatCurrency(currentEstate.total - currentEstate.funeral - currentEstate.debts - currentEstate.will)}
              </Text>
            </View>
          </View>
        </ScrollView>
