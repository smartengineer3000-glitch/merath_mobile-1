...
- [**tests**/inheritance.test.ts](__tests__/inheritance.test.ts)
- [**tests**/audit-log.test.ts](__tests__/audit-log.test.ts)
- [**tests**/hooks.test.ts](__tests__/hooks.test.ts)
- [**tests**/components.test.ts](__tests__/components.test.ts)
- [**tests**/integration.test.ts](__tests__/integration.test.ts)
- [**tests**/performance.test.ts](__tests__/performance.test.ts)
